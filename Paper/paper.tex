...
\begin{document}
	...
	\begin{abstract}
		...
		Therefore, we measured file access times in various test series and developed different models for predicting access times. 
	...
	%		\includegraphics[width=0.47\textwidth]{src/ema.png}
	%		\caption{Exponential moving average (in red) for a function with periodic peaks}
	%		\label{periodic}
	%	\end{minipage}
	%\end{figure}
	\fig{width=.47\textwidth}{src/ema.png}{Exponential moving average (in red) for a function with periodic peaks}	
	...
	\tab{correlations}{Correlations between file access parameters and access time}{
		...
		\begin{tabular}{|r|r|r|}\hline%
			...
			\csvreader[late after line=\\\hline]%
			{src/data_summary_correlations.csv}{Attribut=\Attribut,seq = \seq, rnd = \rnd}%
			{\Attribut & \seq &\rnd}%
		\end{tabular}
	}
