...
\begin{table}
	...
	\caption{Metainformationen über OpTyp}
	\label{tab:metaoptyp}
\end{table}
...
\begin{figure}
	...
	\caption{Messungen der Laufzeiten als Zeitreihe dargestellt}
...
\begin{figure}
	...
	\subfloat[Vorhersagen des Modells, farblich gekennzeichnete Fehlerklassen]{
		\includegraphics[width=.55\textwidth]{Bilder/Plots/error_class/exploration/plot_durationToPredErrorclasses_seq.png}
	} 	
...
\begin{figure}
	...
	\subfloat[Vorhersagen des Modells, farblich gekennzeichnete Fehlerklassen]{
		\includegraphics[width=.55\textwidth]{Bilder/Plots/error_class/exploration/plot_durationToPredErrorclasses_rnd.png}
	} 	
	\caption{Verwendung des K-Means Algorithmus zur Bestimmung der Fehlerklassen auf cached-off0-rnd mit der Vorhersage von \glqq LinReg G\grqq}
...
\begin{table}
	\subfloat[cached-off0-seq]{
		\begin{tabular}{|l|l|l|l|l|l|}\hline%
			Modell & MAF (s)  & RMAF (\%) & RMQA (\%) & RQ3 (\%) & RMax (\%) \\\hline\hline
			\csvreader[late after line=\\\hline]%
			{CSV/baselines/latex_baseline_seq_results.csv}{Modell=\Model,MAF=\MAF,RMAF=\RMAF, RMQA = \RMQA, Q3 = \Q3, Max = \Max}%
	...
	\subfloat[cached-off0-rnd]{
		\begin{tabular}{|l|l|l|l|l|l|}\hline%
			Modell & MAF (s)  & RMAF (\%) & RMQA (\%) & RQ3 (\%) & RMax (\%) \\\hline\hline
			\csvreader[late after line=\\\hline]%
			{CSV/baselines/latex_baseline_rnd_results.csv}{Modell=\Model,MAF=\MAF,RMAF=\RMAF, RMQA = \RMQA, Q3 = \Q3, Max = \Max}%
			{\Model & \MAF & \RMAF & \RMQA & \Q3 & \Max}%
		\end{tabular}
	}
...
\begin{table}
	\subfloat[cached-off0-seq]{
		\begin{tabular}{|l|l|l|l|l|l|}\hline%
			Modell & MAF (s)  & RMAF (\%) & RMQA (\%) & RQ3 (\%) & RMax (\%) \\\hline\hline
			\csvreader[late after line=\\\hline]%
			{CSV/models/latex_seq_results.csv}{Modell=\Model,MAF=\MAF,RMAF=\RMAF, RMQA = \RMQA, Q3 = \Q3, Max = \Max}%
			{\Model & \MAF & \RMAF & \RMQA & \Q3 & \Max}%
		\end{tabular}
	} \\
	\subfloat[cached-off0-rnd]{
		\begin{tabular}{|l|l|l|l|l|l|}\hline%
			Modell & MAF (s)  & RMAF (\%) & RMQA (\%) & RQ3 (\%) & RMax (\%) \\\hline\hline
			\csvreader[late after line=\\\hline]%
			{CSV/models/latex_rnd_results.csv}{Modell=\Model,MAF=\MAF,RMAF=\RMAF, RMQA = \RMQA, Q3 = \Q3, Max = \Max}%
			{\Model & \MAF & \RMAF & \RMQA & \Q3 & \Max}%
		\end{tabular}
	}
...
\begin{table}
	\subfloat[cached-off0-seq]{
		\begin{tabular}{|l|l|l|l|l|}\hline%
			Modell & verdeckte Schichten & Neuronen & Iterationen & Trainingsdauer \\\hline\hline
			\csvreader[late after line=\\\hline]%
