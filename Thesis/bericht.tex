...
\begin{figure}[h]
	...
	\end{center}
	\caption{Zweischichtiges Netz Quelle: Offnfopt, URL}
	%https://de.wikipedia.org/w/index.php?title=Datei:Multi-Layer_Neural_Network-Vector.svg&lang=de
	\label{fig:Schichten}
\end{figure}
...
\begin{figure}
	...
	\caption{Lineare Separierbarkeit, Quelle: Mekeor, URL}
	%https://de.wikipedia.org/wiki/Datei:Separability_YES.svg
	%https://de.wikipedia.org/wiki/Datei:Separability_NO.svg
